...
final class StudentAttendanceTest extends TestCase
{
    ...
    public function test_student_attendance_returns_database_backed_contract(): void
    {
        ...
        $response
            ...
            ->assertJsonPath('data.summary.overallAttendance', 88)
            ->assertJsonPath('data.summary.totalSessions', 600)
            ->assertJsonPath('data.summary.comparisonVsLast4Weeks.label', 'Calculated from attendance records')
